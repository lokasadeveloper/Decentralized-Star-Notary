...
contract StarNotary is ERC721Full, ERC721Mintable {
    ...
    event StarForSale(address sender, uint256 tokenId, uint256 price);
    ...
    constructor() ERC721Full("Crypto Lucky Star", "CLSTAR") public { }
    ...
    function putStarUpForSale(uint256 _tokenId, uint256 _price) public {
        ...
        emit StarForSale(msg.sender, _tokenId, _price);
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "sender must be the owner of either one token "
        );

        //require (
        //    tokenIdToStarInfo[_tokenId1] && tokenIdToStarInfo[_tokenId2],
        //    "Both token id must valid"
        //);
